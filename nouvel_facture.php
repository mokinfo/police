                    ...
                    <form action="Nouvel_facture_enregistre" method="POST">
                      <div class="row d-flex align-items-baseline">
                        <div class="col-xl-9">
                          ...
                          <input type="hidden" name="idp" value="<?php echo $idpr; ?>">
                      ...
                      <div class="container">
                        ...
                        <?php 
                          ...
                          $querys = "SELECT * FROM patient WHERE idp = '$idpr'";
                            ...
                            <tbody>
                              <?php 
                                ...
                                if(isset($_POST['datedebut']) && isset($_POST['datefin']))
                                {
                                    ...
                                    $query = "SELECT * FROM facture WHERE datef BETWEEN '$from_date' AND '$to_date' and idp = '$idp' and etat = 'IMPAYER'";
