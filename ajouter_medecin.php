            ...
            <div class="card">
              <div class="card-header bg-primary"> 
                <?php 
                          ...
                          $sql1 = $conn1->query('SELECT * FROM medecin');
                      ...
                      <tbody><?php 
                          while($data1 = $sql1->fetch_array()){
                            echo '<tr>
                              <td>'.$data1['idmed'].'</td>
                              <td>'.$data1['nom'].'</td>
                              <td>'.$data1['specialite'].'</td>
                              <td>'.$data1['email'].'</td>
                              <td>'.$data1['tel'].'</td>
                              <td>
                              <a href="affiche_medecin.php?id=' . $data1['idmed'] .' "><i class="fas fa-eye"></i></a> | <a href="#" onclick="confirmDelete(' . $data1['idmed'] . ')"><i class="fas fa-trash-alt" style="color:red;"></i></a></td>
                            </tr>';
                          }
                        ?>
                      </tbody>
...
function confirmDelete(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = 'delete_medecin.php?id=' + id;
        }
    });
}
</script>
            ...
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <div class="modal-header bg-secondary   ">
                  <h5 class="modal-title" id="exampleModalLabel">Nouveau Médecin</h5>
                    ...
                    <div class="col-md-12">
                      <div class="card">
                        <div class="card-header"> 
                          <?php 
                            $connx = new mysqli('localhost', 'root', '', 'spn');
                            $sqlx = $connx->query("SELECT count(idmed) AS idmed FROM medecin");
                          ?>
                          <br>
                          <h3 class="card-title">Ajouter le Médecin numéro : <b>
                            <?php 
                        ...
                        <form class="form-horizontal" action="Ajout_medecin" method="POST">
                          <div class="card-body">
                            <div class="form-group row">
                              <div class="col-sm-9"> 
                                 <input type="hidden" name="idmed" value="<?php   echo $sx;
                            ...
                            <div class="form-group row">
                              <label for="inputEmail3" class="col-sm-3 col-form-label">Spécialité : </label>
                              <div class="col-sm-9">
                                 <input type="text" name="specialite" class="form-control" id="inputEmail3">
                              </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                              <label for="inputEmail3" class="col-sm-3 col-form-label">Téléphone :</label>
                              <div class="col-sm-9">
                                  <input type="text" name="tel" class="form-control" id="inputEmail3" pattern="[0-9]{8}" title="Veuillez entrer un numéro de téléphone valide (8 chiffres)" required>
                              </div>
                            </div>
