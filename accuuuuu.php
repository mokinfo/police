                ...
                <div class="modal-body">
                  <form action="Ajoutpatient" method="post">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          <label for="matricule" id="matriculeLabel">Matricule</label>
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          <label>Numéro de Carte CNSS</label>
                          <input type="text" class="form-control" name="cnss" placeholder="Numéro de la carte CNSS">
                        </div>
                      </div>
                      <div class="col-sm-4">
                        <div class="form-group">
