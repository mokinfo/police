...
<?php  
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="Rendez_vous?id=<?php echo $patienf->idp; ?>" class="nav-link" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-address-card"></i> Prochain Rdv</a>
      </li>
    </ul>
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <label  for="inputEmail3" class="col-sm-12 col-form-label bg-info">Examen clinique</label>
                          ...
                          <label  for="inputEmail3" class="col-sm-12 col-form-label bg-info">Examen Demandé</label>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <textarea class="form-control" rows="3" name="para" disabled></textarea>
                          <label  for="inputEmail3" class="col-sm-12 col-form-label bg-warning">Note</label>
                          <textarea class="form-control" rows="3" name="note" disabled><?php echo $patienf->note ; ?></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
  ...
  <!-- /.content -->
          ...
          <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <div class="modal-header bg-light   ">
                  <h5 class="modal-title" id="exampleModalLabel2">Prochain Rendez-vous</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  ...
                  <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="gene" role="tabpanel" aria-labelledby="home-tab">
                      <div class="row">
                        <div class="col-sm-12">
                        <form action="Prochain_RDV" method="post">
                          <?php   
                            $cosen = new mysqli('localhost', 'root', '', 'spn');
                            ...
                            while($rowen = mysqli_fetch_assoc($psen)){
                                $sen = $rowen["id"] + 1;
                          ?>
                          <input type="hidden" name="idrdv" value="<?php echo $sen;} ?>">
                          <div class="form-group">
                            <label>Patient</label>
                          ...
                          <div class="form-group">
                            <label>Â</label>
                            <input type="date" class="form-control" name="date_pro_ rdv">
                          </div>
                          <div class="form-group">
                            <label>Médecin</label>
                            <?php 
                            ...
                            ?>
                            <select class="form-control" name="medecin" id="nom_med">
                          ...
                          <div class="form-group">
                            <label>Type</label>
                            <input type="text" class="form-control" name="type_rdv">
                          </div>
                          <?php $date_heur_rdv = date("d/m/Y G:i"); ?>
                          <input type="hidden" name="heura" value="<?php echo $date_heur_rdv; ?>">
