                            ...
                            <tbody><?php 
                                while($data = $sql->fetch_array()){
                                  if ($data['service'] == "MI") {
                                    ...
                                    $fik = "Pédiatrie";
                                  }else if ($data['service'] == "OP") {
                                    $fik = "Chirurgie";
                                  }else if ($data['service'] == "GO") {
                                    $fik = "Gynécologie obstétrique";
                                  }
                                  if ($data['sex'] == "Féminin") {
                      ...
                      <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <div class="row">
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                              <label>Lit</label>
                              <input type="text" class="form-control" name="lit">
                            </div>
                          </div>
                        </div>
                      </div>
