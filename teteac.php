...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-plus text-info"></i> Nouvelle entrée</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link" data-toggle="modal" data-target="#exampleModal3"><i class="fas fa-vial text-danger"></i> Nouvel Examen</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
