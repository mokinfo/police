          ...
          <div class="col-md-12">
            <div id="London" class="tabcontent">
              <div class="row">
                <div class="col-md-12">
                  <div class="card">
                    <form action="Modifier_operation" method="POST">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-8"> 
                            <div class="form-group">
                              ...
                              <input class="form-control" type="hidden" name="ido" value="<?php  echo $data['ido']; ?>">
                          ...
                          <div class="col-sm-12">
                            <div class="form-group">
                              <label>Indication</label>
                                ...
                                <input class="form-control" type="text" name="indic" value="<?php  echo $data['indic']; ?>">
                            </div>
                          </div>
                          <div class="col-sm-3">
                            <div class="form-group">
                              <label>Date début</label>
                                <input class="form-control" type="date" name="datedop" value="<?php  echo $data['datedop'] ?>">
                            </div>
                          </div>
                          <div class="col-sm-3">
                            <div class="form-group">
                              <label>Heure début</label>
                                <input class="form-control" type="time" name="heurdop" min="00:00" max="23:59" step="1800" value="<?php  echo $data['heurdop'] ?>">
                            </div>
                          </div>
                          <div class="col-sm-3">
                            <div class="form-group">
                              <label>Date Fin</label>
                                <input class="form-control" type="date" name="datefop" value="<?php  echo $data['datefop'] ?>">
                            </div>
                          </div>
                          <div class="col-sm-3">
                            <div class="form-group">
                              <label>Heure Fin</label>
                                <input class="form-control" type="time" name="heurfop" min="00:00" max="23:59" step="1800" value="<?php  echo $data['heurfop'] ?>">
                            </div>
                          </div>
                          <div class="col-sm-6">
                            <div class="form-group">
                              <label>Statut</label>
                                <input class="form-control" type="text" name="statu" value="<?php  echo $data['statu']; ?>">
                            </div>
                          </div>
                          <div class="col-sm-6">
                            <div class="form-group">
                              <label>Motif d'annulation</label>
                                <input class="form-control" type="text" name="mode_ann" value="<?php  echo $data['mode_ann']; ?>">
                            </div>
                          </div>
                          <div class="col-sm-12">
                            <div class="card">
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                              <label>Transfert sanguine</label>
                                <input class="form-control" type="text" name="trans_sang" value="<?php  echo $data['trans_sang']; ?>">
                            </div>
                          </div>
                          <div class="col-sm-6">
                            <div class="form-group">
                              <label>Position patient</label>
                                <input class="form-control" type="text" name="posi_pat" value="<?php  echo $data['posi_pat']; ?>">
                            </div>
                          </div>
                          <div class="col-sm-12">
                            <div class="form-group">
                              <label>Lésions observées</label>
                              <textarea  id="compose-textarea" class="form-control" style="height: 300px" name="loo"><?php echo $data['loo'];  ?></textarea>
                            </div>
                          </div>
                          <div class="col-sm-12">
                            <div class="form-group">
                              <label>Gestes Opératoires</label>
                              <textarea class="form-control" name="goo"><?php echo $data['goo'];  ?></textarea>
                            </div>
                          </div>
                          <div class="col-sm-12">
                            <div class="form-group">
                              <label>Etat final</label>
                              <textarea class="form-control" name="eff"><?php echo $data['eff'];  ?></textarea>
                            </div>
                          </div>
                          <div class="col-sm-12">
                            <div class="form-group">
