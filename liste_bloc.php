                  ...
                  <div class="card">
                    <div class="card-header bg-light">
                      <?php 
                          ...
                          $sql = $conn->query("SELECT operation.ido ,operation.idp ,operation.too, operation.opp, operation.mode_anes, operation.datenrop, patient.nom, patient.civi, patient.sex, patient.age FROM patient, operation where patient.idp = operation.idp ORDER BY operation.ido DESC");
                          ...
                          <table class="table  table-striped table-bordred table-hover" id="jaktab">
                            ...
                            <tbody><?php 
                                while($data = $sql->fetch_array()){
                                  ...
                                  if ($data['too'] == "10F") {$fik = "RM (réanimation d’indication médicale)";}
                                  ...
                                  echo '<tr>
                                    ...
                                    <td>'.$fik.'</td>
                                    <td>'.$oper_nom.'</td>
                                    <td>'.$data['mode_anes'].'</td>
                                    <td>'.$data['datenrop'].'</td>
                                    <td><a href="Affiches_Operations?id=' . $data['ido'] .' " style=\"text-align:center;\"><i class="fas fa-eye fa-2x"></i></a></td>
                                  </tr>';
                                }
