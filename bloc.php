    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-6">
            <!-- small box -->
            <a href="Liste_Bloc" style="text-decoration: none;">
                  ...
                  <div class="card">
                    <div class="card-header bg-light">
                      <?php 
                          ...
                          $sql = $conn->query("SELECT operation.ido ,operation.idp ,operation.too, operation.opp, operation.indic, operation.datedop, operation.heurdop, patient.nom, patient.civi, patient.sex, patient.age FROM patient, operation where patient.idp = operation.idp ORDER BY operation.ido ASC");
                            ...
                            <tbody><?php 
                                while($data = $sql->fetch_array()){
                                  ...
                                  echo '<tr>
                                    ...
                                    <td>'.$fik.'</td>
                                    <td>'.$data['indic'].'</td>
                                    <td>'.$data['datedop'].' - '.$data['heurdop'].'</td>
