      ...
      <div class="container-fluid">
        <div class="row mb-12">
          <div class="col-sm-12">
            ...
            <?php 
            $datess = date("d/m/Y");
              $pieces = $DB->query("SELECT andoc.idexam, andoc.idan, andoc.heurdexam, andoc.datexam, andoc.chk, andoc.motif, patient.idp, patient.civi, patient.nom, patient.sex, patient.age, patient.affect FROM patient, andoc where andoc.idan = patient.idp and andoc.chk = 'NON'");
                          ...
                          <?php   
                            foreach ($pieces as $piece):
                              if($piece->idp & 1){
                                ...
                                echo "<td>" . $piece->motif . "</td>";
                                /*echo "<td><a class=\"add addPanier\" href=\"analysis.php?id=" . $piece->idp . "\"><i class=\"fa fa-save\"></i></a>&nbsp;&nbsp; | &nbsp;&nbsp;<a href=\"delpatient.php?id=" . $piece->idp . "\"><i class=\"fa fa-edit\"></i></a>&nbsp;&nbsp; | &nbsp;&nbsp; <a href=\"delpatient.php?id=" . $piece->idp . "\"><i class=\"fa fa-trash\"></i></a></tr>";*/
                                echo "<td><a href=\"Examen?id=" . $piece->idexam . "\"><i class=\"fa fa-eye align-items-center\" ></i></a></tr>";
                              }
                              /*}
                  ...
                  <div class="card">
                    <div class="card-header bg-info">
                      <?php 
                          ...
                          $sql = $conn->query("SELECT * FROM examen ORDER BY ide DESC");
                        
                        $row_cnt = $sql->num_rows;
                      ?>
                      <h5 class="card-title">Résultat des examens : <b><?php  echo($row_cnt); ?></b></h5>
                    </div>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-12">
                            ...
                            <tbody><?php 
                                while($data = $sql->fetch_array()){
                                  echo '<tr>
                                    ...
                                    <td>'.$data['age'].'</td>
                                    <td>'.$data['sex'].'</td>
                                    <td>'.$data['heurfexam'].'</td>
                                    <td>'.$data['datej'].'</td>
                                    <td><a href="Affiche_Resultat?id=' . $data['ide'] .' " style=\"text-align:center;\"><i class="fas fa-eye fa-2x"></i></a></td>
                                  </tr>';
                                }
