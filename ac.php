                  ...
                  <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="gene" role="tabpanel" aria-labelledby="home-tab">
                      <div class="row">
                        ...
                        $psen = $DB->query("SELECT consult.idcons, consult.datcons, consult.ante, consult.motif, consult.examc, consult.heurdc, consult.heurfc, consult.statcons, patient.idp, patient.nom, patient.civi, patient.age, patient.sitfam  FROM patient, consult where patient.idp = consult.idpa and consult.idcons = '$ids' ");
                        ...
                        <div class="main-form mt-3 border-bottom">
                          <?php 
                            ...
                            $sql = $DB->query("SELECT MAX(id) AS idord FROM prescription");
                        ...
                        <div class="card-footer">
                          <div class="col-sm-12">
                            <button type="submit" name="save_multiple_data" class="btn btn-info">Enregistrer</button>
                          </div>
                        </div>
                      </div>
                    </div>
