                        ...
                        <table class="table table-borderd">
                            ...
                            <?php 
                                ...
                                if(isset($_GET['from_date']) && isset($_GET['to_date']))
                                {
                                    ...
                                    $query = "SELECT * FROM userse WHERE created_at BETWEEN '$from_date' AND '$to_date' ";
              ...
              <div class="col-md-12">
                  <div class="card">
                    <div class="card-header bg-warning">
                      ...
                      <div class="form-group">
                        Date de début
                        <input type="date" class="form-control" name="motif">
                      </div>
                    </div>
                  </div>
              </div>
                  ...
                  <div class="card">
                    <a href="Militaire">
                      <div class="card-header bg-warning">
                        ...
                        ?>
                        <h5 class="card-title" style="text-align: center;"> Militaire : <b><?php  echo($row_cnt); ?></b></h5>
                      </div>
                      <div class="card-body">
                        <center> <img src="image/mili.png"></center>
                      </div>
                    </a>
                  </div>
                  <!-- /.card -->
                  ...
                  <div class="card">
                    <div class="card-header bg-secondary">
                      <?php 
                          ...
                          $row_cnt = $sql->num_rows;
                      ?>
                      <h5 class="card-title" style="text-align: center;"> Garde Républicaine : <b><?php  echo($row_cnt); ?></b></h5>
                    </div>                    
                    <div class="card-body">
                      <center><img src="image/garde.png"></center>
                    </div>
                  </div>
                  <!-- /.card -->
                </div>
                  ...
                  <div class="card">
                    <div class="card-header bg-success">
                      <?php 
                          ...
                          $row_cnt = $sql->num_rows;
                      ?>
                      <h5 class="card-title" style="text-align: center;"> Garde de côte : <b><?php  echo($row_cnt); ?></b></h5>
                    </div>
                    <div class="card-body">
                      <center><img src="image/cote.png"></center>
                    </div>
                  </div>
                  <!-- /.card -->
                </div>
                  ...
                  <div class="card">
                    <div class="card-header bg-primary">
                      <?php 
                          ...
                          $row_cnt = $sql->num_rows;
                      ?>
                      <h5 class="card-title" style="text-align: center;"> Gendarmerie : <b><?php  echo($row_cnt); ?></b></h5>
                    </div>
                    <div class="card-body">
                      <center><img src="image/gend.png"></center>
                    </div>
                  </div>
                  <!-- /.card -->
                </div>
