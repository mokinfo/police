        ...
        <div class="row">
          <div class="col-lg-12 col-6">
            ...
            <div class="small-box bg-secondary">
              <div class="inner">
                <center><b style="text-align:center; font-family:ALGERIAN; font-size: 60px;">Liste des factures</b></center>
              </div>
            </div>
            </a>
          </div>
                  ...
                  <div class="card">
                    <div class="card-header bg-light">
                      <?php 
                          ...
                          $sql = $conn->query("SELECT facture.idf ,facture.desg ,facture.datef, facture.type_paix, facture.mt, facture.etat, facture.date_paix, patient.nom, patient.civi, patient.sex, patient.age FROM patient, facture where patient.idp = facture.idp ORDER BY facture.idf DESC");
                        
                        $row_cnt = $sql->num_rows;
                      ?>
                      <h5 class="card-title">Listes des factures : <b><?php  echo($row_cnt); ?></b></h5>
                    </div>
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-12">
                            ...
                            <tbody><?php 
                                while($data = $sql->fetch_array()){
                                  echo '<tr>
                                    ...
                                    <td>'.$data['datef'].'</td>
                                    <td>'.$data['mt'].'</td>
                                    <td><i class=\"fa fa-user text-success align-items-center\"> Payer</i></td>
                                    <td>'.$etat.'</td>
                                    <td><a href="Affiche_Facturation?id=' . $data['idh'] .' " style=\"text-align:center;\"><i class="fas fa-eye fa-2x"></i></a></td>
                                  </tr>';
                                }
                              ?>
                            </tbody>
